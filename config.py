...
c.hints.selectors['scrollable'] = ['body','ytd-app','ytd-browse' ,'div[id="guide-inner-content"]','[player]', '[contents]','[playlist]','[container]' ]
...
c.url.searchengines = {'DEFAULT': 'https://www.google.nl/search?q={}',
                       ...
                       'rdoc': 'https://docs.rs/sdl2/latest/sdl2/?search={}',
                       ...
                       'zlib' : 'https://lib-gbnuwuuv3xmgbtpmwgnpcyff.booksc.me/s/{}',
...
config.source("./themes/themes/minimal/base16-catppuccin.config.py")
